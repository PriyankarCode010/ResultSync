...
import { Sem3, Students } from '@/utils/schema'; // Adjust the import according to your setup
...
const subjects = [
  ...
  { name: "Linux lab", key: "lab2" }
];

const Sem3Student = ({ batch }) => {
    ...
    const fetchData = async () => {
      try {
        const students = await db
          ...
          .from(Sem3)
          .innerJoin(Students, and(eq(Sem3.uucms, Students.uucms), eq(Students.batch, batch))) // Filtering by batch
          .execute();
  ...
  return (
    <div className="container mx-auto p-4 text-white">
      <h1 className="text-2xl font-bold mb-4 text-center">{batch} Batch - 3rd Sem Student Marks (90+)</h1>
